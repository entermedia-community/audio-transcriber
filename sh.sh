...
# Launch Transcriber Docker instance with dedicated IP and external models directory
...
# Pull latest Transcriber image
docker pull transcriber

# Check and create Docker network if not exists
NETWORK_NAME="transcriber"
...
echo "Transcriber instance $INSTANCE_NAME is running on IP: $IP_ADDR."
